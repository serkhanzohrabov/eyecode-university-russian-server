...
useEffect(() => {
    ...
    return(
        ...
        <Container>
               ...
               <header
                  className="header">
          <Link href='/starcode'>  <div className="logo"></div> </Link> 
                   <div className="account"><CircleUserRound color="red"/> {name}</div>
                ...
                <main>
                  <div className="result-card-header">
                                       <div className="result-card-header-title">
                                          ...
                                          <div className='result-card-header-percent'>    <Counter point={score * 100 / 30} /> <Percent size={16} color='black' />  </div>    
                                       </div>
